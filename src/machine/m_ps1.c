...
machine_ps1_m2133_init(const machine_t *model)
{
	/* IBM PS/1 Model 2133 */
	/* IBM PS/1 Model 2155 */
	/* NOTE: These machines use a system board with a VLSI chipset and IBM BIOS */
	int ret;
...
int
machine_ps1_m2168_init(const machine_t *model)
{
	/* IBM PS/1 Model 2168          */
	/* IBM Aptiva 2168 (486 models) */
	/* NOTE: These machines use a system board with a VLSI chipset and IBM BIOS */
	int ret;

	ret = bios_load_linear(L"roms/machines/ibmps1_2133/65G9498_le-ibm_20-09-93.BIN",
		0x000e0000, 131072, 0);
