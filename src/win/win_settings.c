...
extern int is486;
static int listtomachinetype[8192], machinetypetolist[8192];
static int listtomachine[8192], machinetolist[8192];
...
static int max_spt = 266305, max_hpc = 255, max_tracks = 266305;
